...
st.set_page_config(page_title="📈 Benefits of Customer Churn Prediction", layout="centered")

st.title("📈 Benefits of Customer Churn Prediction")
st.markdown("---")

st.markdown("### 1. Increased Customer Retention")
st.write("By identifying customers who are likely to leave, companies can take proactive actions—like personalized offers or follow-up communication—to keep them.")
